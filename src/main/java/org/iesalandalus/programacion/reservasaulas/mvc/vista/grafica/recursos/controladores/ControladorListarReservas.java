...
public class ControladorListarReservas {
	...
	void initialize() {
		...
		assert btBorrarReserva != null
				: "fx:id=\"btBorrarReserva\" was not injected: check your FXML file 'Reservas.fxml'.";
		assert fxReservas != null : "fx:id=\"fxReservas\" was not injected: check your FXML file 'Reservas.fxml'.";
		assert btInsertarReserva != null
				: "fx:id=\"btInsertarReserva\" was not injected: check your FXML file 'Reservas.fxml'.";
		...
		assert btInsertarProf != null
				: "fx:id=\"btInsertarProf\" was not injected: check your FXML file 'Profesores.fxml'.";
		assert btBorrarProf != null
				: "fx:id=\"btBorrarProf\" was not injected: check your FXML file 'Profesores.fxml'.";
		assert tbNombreAulaReserva != null
				: "fx:id=\"tbNombreAulaReserva\" was not injected: check your FXML file 'Reservas.fxml'.";
		assert tbClases != null : "fx:id=\"tbClases\" was not injected: check your FXML file 'Reservas.fxml'.";
		assert tbPuntosReserva != null
				: "fx:id=\"tbPuntosReserva\" was not injected: check your FXML file 'Reservas.fxml'.";
		assert tbNombreReserva != null
				: "fx:id=\"tbNombreReserva\" was not injected: check your FXML file 'Reservas.fxml'.";
		assert tbPermanencia != null
				: "fx:id=\"tbPermanencia\" was not injected: check your FXML file 'Reservas.fxml'.";
		...
		assert tbCorreoReserva != null
				: "fx:id=\"tbCorreoReserva\" was not injected: check your FXML file 'Reservas.fxml'.";
		assert tbOpciones != null : "fx:id=\"tbOpciones\" was not injected: check your FXML file 'Reservas.fxml'.";

		// Tabla Reservas
		tbNombreReserva.setCellValueFactory(
				cellData -> new SimpleStringProperty(cellData.getValue().getProfesor().getNombre()));
		tbCorreoReserva.setCellValueFactory(
				cellData -> new SimpleStringProperty(cellData.getValue().getProfesor().getCorreo()));
		tbNombreAulaReserva
				.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().getAula().getNombre()));
		tbPermanencia.setCellValueFactory(
	...
	void btBorrarReserva(ActionEvent event) throws OperationNotSupportedException {
		...
		if (Dialogos.mostrarDialogoConfirmacion("Borrar", "¿Estás seguro de que desea borrar la reserva seleccionada?",
				null)) {
